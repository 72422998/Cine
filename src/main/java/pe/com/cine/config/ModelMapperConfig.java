...
public class ModelMapperConfig {
    ...
    public ModelMapper modelMapper(){
        ...
        modelMapper.createTypeMap(PeliculaDTO.class, Pelicula.class).addMappings(mapper -> mapper.map(PeliculaDTO::getPeliculaId, Pelicula::setPeliculaId))
        .addMappings(mapper -> mapper.skip(Pelicula::setCategoria));

        // Configuración para la entidad Categoria
        modelMapper.createTypeMap(CategoriaDTO.class, Categoria.class).addMappings(mapper -> mapper.map(CategoriaDTO::getCategoriaId, Categoria::setCategoriaId));
